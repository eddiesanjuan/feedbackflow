  ...
  return (
    <div className="view-transition flex flex-col items-center justify-center h-full p-6">
      ...
      <button
        ...
        className="mb-4 px-4 py-2 btn-macos btn-macos-secondary disabled:opacity-50 text-sm flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      >
      ...
      <div className="flex gap-3 w-full">
        <button
          ...
          className="flex-1 px-4 py-3 btn-macos btn-macos-secondary disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
        >
          Cancel
        </button>
        <button
          ...
          aria-busy={isLoading}
          className="flex-1 px-4 py-3 btn-macos btn-macos-danger disabled:opacity-50 text-white font-medium flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2"
        >
          {isLoading ? (
            <>
